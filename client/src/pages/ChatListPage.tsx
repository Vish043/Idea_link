    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-gray-600">View and manage all your conversations</p>
        </div>

        {/* Personal Chats */}
        {conversations.personal.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Personal Chats</h2>
        ...
        {conversations.group.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Group Chats</h2>
            <div className="space-y-3">
              {conversations.group.map((chat) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 truncate">{chat.idea.title}</h3>
